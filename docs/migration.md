...
Tabstash’s `@tabstash/linkoi` adapter pins `@linkoi/core` and `@linkoi/worker` to npm version 0.1.1. The temporary vendor archives and root override have been removed.
